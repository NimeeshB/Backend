...
export const verifyJWT = asyncHandler(async(req, _, next) => {
    try {
        ...
        //if the token is valid, jwt.verify also decodes the token, returning the payload (the data that was originally encoded into the token). This payload often contains information like the user's ID, roles, and expiration time.
